  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // Cette ligne vide l'URL de navigation avant de charger la nouvelle
        // Elle casse toute tentative de React Router de préfixer l'URL
        window.location.href = new URL(shopifyUrl).toString();
