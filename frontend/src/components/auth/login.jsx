...
const Login = () => {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        window.location.assign(new URL(targetUrl).href)
      }, delay);
